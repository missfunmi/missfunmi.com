      ...
      <body>
        <header>
          <nav>
            ...
            <p class="sub-header">
              <p><strong>Last Published: </strong><xsl:value-of select="atom:feed/atom:updated"/>.</p>
              <p><a href="http://validator.w3.org/feed/check.cgi?url={/atom:feed/atom:link[not(@rel)]/@href}feed.xml" target="_blank">This is a valid Atom 1.0 feed</a></p>
              <p class="about-feeds">This is a web feed, also known as an RSS or Atom feed. Subscribe by copying the URL from the address bar into your newsreader. I like <a href="https://feedly.com/" target="_blank">Feedly</a>, but there are plenty of other options. Visit <a href="https://aboutfeeds.com" target="_blank">About Feeds</a> to get started &#x2014; it’s free.</p>
            </p>
          </nav>
        </header>
        ...
        <main>
          ...
          <atom:rights><div class="copyright">
            <p><span class="copyright-maintext">©&#160;<strong>2025&#160;<xsl:value-of select="atom:feed/atom:author/atom:name"/>.</strong></span><span class="copyright-subtext">&#160;All rights reserved.</span></p>
          </div></atom:rights>
        </main>
