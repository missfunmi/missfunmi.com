...
For some reason, I find myself having to type out dates a lot — in race reports, meeting notes, emails, blogposts, TODO lists. I usually like to include the weekday so I don't have to look it up later, but that meant I had to first look it up in my calendar in order to type it out a date like `Sun Jun 14, 2026` on my computer. This seemed to me like a problem text replacement could solve, but how? I wasn't quite sure.
